 ...
 *
 * Sin dependencias de TypeORM ni de Nest a propósito: debe ser trivialmente
 * testeable y portable a `mobile/src/lib/nameMatching.ts`, que reimplementa
 * exactamente esta misma lógica (no hay paquete compartido entre los
 * repositorios). Cualquier cambio acá debe replicarse ahí — ver la § "Riesgo
 * de divergencia backend/móvil" del spec 68 y su precedente doloroso
 * (`CROP_FIELD_MAP`, spec 49, Bug A).
 *
