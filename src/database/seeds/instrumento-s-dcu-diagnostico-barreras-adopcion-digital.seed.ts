...
export async function seedInstrumentoSDcuDiagnosticoBarrerasAdopcionDigital(
  manager: EntityManager,
): Promise<void> {
  ...
  const [sec1, sec2, sec3, sec4, sec5, sec6] = await Promise.all([
    sectionRepo.save(
      sectionRepo.create({
        name: `Barrera de Acceso y Conectividad (B1)`,
        order: 1,
        instrument,
      }),
    ),
    ...
    sectionRepo.save(
      sectionRepo.create({
        name: `Prácticas Actuales y Mapeo de Fricciones (Módulo C)`,
        order: 4,
        instrument,
      }),
    ),
    sectionRepo.save(
      sectionRepo.create({
        name: `Necesidades y Valoración de la Solución (Módulo D)`,
        order: 5,
        instrument,
      }),
    ),
    sectionRepo.save(
      sectionRepo.create({
        name: `Confianza en Instituciones (Módulo E.5)`,
        order: 6,
        instrument,
      }),
    ),
