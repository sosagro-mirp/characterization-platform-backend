...
export async function seedInstrumentoS6aGeneracionYManejoDeResiduosCacao(
  manager: EntityManager,
): Promise<void> {
  ...
  // ── 6.2 Caracterización Detallada de Residuos ──
  {
    ...
    const opts_39a9251f_1739_42bc_ab07_fbc4dd794548 = await saveOptions(
      manager,
      q_39a9251f_1739_42bc_ab07_fbc4dd794548,
      [{ text: `No sabe / No aplica` }, { text: `No` }, { text: `Sí` }],
    );
    const opt_3b66c3d2_a040_4368_a2f3_18a3cf39e96b =
      opts_39a9251f_1739_42bc_ab07_fbc4dd794548.get(`Sí`)!;
    ...
    const opts_9d1a8b50_ce86_4098_a625_d1a50e5e0f40 = await saveOptions(
      manager,
      q_9d1a8b50_ce86_4098_a625_d1a50e5e0f40,
      [{ text: `No sabe / No aplica` }, { text: `Sí` }, { text: `No` }],
    );
    const opt_178d71dc_c3dc_4e9c_b17e_0439c1c98fcc =
      opts_9d1a8b50_ce86_4098_a625_d1a50e5e0f40.get(`Sí`)!;
