...
export async function seedInstrumentoS1aIdentificacionDelEncuestadoPropietarioProductor(
  manager: EntityManager,
): Promise<void> {
  ...
  const [sec1, sec2, sec3] = await Promise.all([
    sectionRepo.save(
      sectionRepo.create({
        name: `Identificación del encuestado/propietario/productor`,
        order: 1,
        instrument,
      }),
    ),
    sectionRepo.save(
      sectionRepo.create({ name: `Ubicación`, order: 2, instrument }),
    ),
    sectionRepo.save(
      sectionRepo.create({
        name: `Acceso desde el Casco Urbano`,
        order: 3,
        instrument,
      }),
    ),
  ...
  // ── Ubicación ──
  {
    ...
    await saveOptions(manager, q_e8cd045f_1901_40b6_b8fb_9ec49dd5f1b3, [
      ...
      { text: `Antioquia`, metadataId: '37fcdf20-1406-42b0-b4a6-39a959c9b4ce' },
      {
        ...
        metadataId: 'ba99ad24-9961-446c-ad77-10128e882505',
      },
      {
        text: `La Guajira`,
        metadataId: 'c917507e-a955-4236-b3d9-181ea61f2c51',
      },
    ...
    await saveOptions(manager, q_25f2a0ae_7e48_489e_a46c_37e28cf1a662, [
      {
        text: `Villavicencio`,
        metadataId: '69656a84-3460-4974-b7d3-ec17fcdb9a8c',
      },
      ...
      {
        text: `Angelópolis`,
        metadataId: '3b5b83ca-9b1c-4c5b-bdea-08b3f38244fc',
      },
      ...
      {
        text: `Campamento`,
        metadataId: 'b03904ce-ca12-439f-8e19-305621237e77',
      },
      {
        text: `Cañasgordas`,
        metadataId: 'aae5db71-16ec-405f-8abe-b4cf716d8cb7',
      },
      ...
      { text: `Carepa`, metadataId: '5b48af90-60d4-4b94-b264-19f28e908bab' },
      {
        ...
        metadataId: '070682cd-61f4-4178-8360-07327cf6c038',
      },
      ...
      {
        text: `Concepción`,
        metadataId: '3feebfb8-6b0d-41c9-a492-cade26f2efe8',
      },
      { text: `Concordia`, metadataId: '80af5cab-b0e0-4e21-a7a6-54dd6c689492' },
      {
        text: `Copacabana`,
        metadataId: '7a45bd00-382b-420e-a16e-579dbf580a90',
      },
      { text: `Dabeiba`, metadataId: '064709e9-6170-4dff-8d73-5090620cfc97' },
      {
        text: `Don Matías`,
        metadataId: '4a4d9280-9be9-4010-b7b9-af92b8c02920',
      },
      ...
      {
        text: `Entrerríos`,
        metadataId: 'e0fa2ef9-3e24-4fbb-aaae-edfbba14693d',
      },
      ...
      {
        text: `Gómez Plata`,
        metadataId: '24a7c04e-c998-4b4e-8aff-a90260886ea8',
      },
      ...
      {
        text: `La Estrella`,
        metadataId: '858fa57f-7d1b-43ca-9478-8c150790f689',
      },
      {
        text: `La Pintada`,
        metadataId: '56f02639-ac1e-4a09-b5b1-82bf7dfc2a21',
      },
      ...
      {
        text: `Montebello`,
        metadataId: 'e7911f04-2427-4e4d-a518-5a68c04cc145',
      },
      ...
      {
        text: `Pueblorrico`,
        metadataId: 'edfe656d-e9fe-442c-aa7c-0002a62d10a7',
      },
      {
        text: `Puerto Berrío`,
        metadataId: 'c48e687c-c033-429f-b9fe-be6df84c1117',
      },
      {
        text: `Puerto Nare`,
        metadataId: '04d4416f-44bd-42c5-bd98-b1597ecfcf79',
      },
      {
        text: `Puerto Triunfo`,
        metadataId: '7ee1691f-da6a-4bb5-891c-74bec2919fbc',
      },
      ...
      {
        text: `Sabanalarga`,
        metadataId: 'd45a724b-0ffe-4dae-8410-20ef21869379',
      },
      ...
      { text: `Salgar`, metadataId: 'dce05dfb-a19c-4f10-be67-73f9a1fe7e9a' },
      {
        ...
        metadataId: '67d17e2d-10a9-41f1-adb8-6f691bd45ce1',
      },
      {
        text: `San Carlos`,
        metadataId: 'd2d8357b-3a3a-4384-8080-eedc50013a96',
      },
      {
        text: `San Francisco`,
        metadataId: '89eb5b6d-7a4e-4593-ad9f-da715693fcf3',
      },
      {
        text: `San Jerónimo`,
        metadataId: '97cc92c6-02e1-4a3c-9954-8d6c03429106',
      },
      {
        text: `San José de la Montaña`,
        metadataId: '475274e4-c529-4ae4-bc94-f2ac3bbf8173',
      },
      {
        text: `San Juan de Urabá`,
        metadataId: '290fb787-8a0d-4d2b-b75b-66c30733e3b4',
      },
      { text: `San Luis`, metadataId: '92eef083-b131-459f-b14d-015c4d8db13f' },
      {
        text: `San Pedro de los Milagros`,
        metadataId: '468c6176-2ba6-4998-8994-ffa420504cdd',
      },
      {
        text: `San Pedro de Urabá`,
        metadataId: '4933fa8e-91ec-4ca7-a416-b2476c9f3b0d',
      },
      {
        text: `San Rafael`,
        metadataId: '890c4da4-bdbc-48ac-834e-39d57d8a6a86',
      },
      { text: `San Roque`, metadataId: 'b1271170-f0df-4311-8b4a-3ed9612cdfe5' },
      {
        text: `San Vicente Ferrer`,
        metadataId: '23bbd85e-2921-4a6b-98c0-28256e4033af',
      },
      {
        text: `Santa Bárbara`,
        metadataId: '9f878926-2b71-4002-b5e8-d170996829e5',
      },
      {
        text: `Santa Fe de Antioquia`,
        metadataId: 'a6f94bc1-49cc-4e2f-bb6a-2920c923b33c',
      },
      {
        text: `Santa Rosa de Osos`,
        metadataId: '551e6533-7da2-40bd-b15d-b694c37d4a29',
      },
      {
        text: `Santo Domingo`,
        metadataId: '20bba500-7a91-4126-a31e-61055cdeb90e',
      },
      {
        text: `El Santuario`,
        metadataId: '1e953be3-0bde-47b5-8d8b-9b3608368012',
      },
      ...
      {
        text: `Valparaíso`,
        metadataId: '9b103bf3-155e-4244-bbb8-e57f285ce56b',
      },
      ...
      { text: `Venecia`, metadataId: '9e1cdee9-9ced-44ed-bf16-4bcf9eab6371' },
      {
        ...
        metadataId: 'c1f88ba1-2728-4bd2-b31b-6b909343d9e2',
      },
      ...
      {
        text: `Ciudad Bolívar`,
        metadataId: 'bd737307-f5a2-40d2-a49b-ed1ac53d61c1',
      },
      { text: `Albania`, metadataId: 'c2a51be9-a6f7-4bbf-9750-a81b7a3949d0' },
      {
        text: `Belén de los Andaquíes`,
        metadataId: '476377fe-198b-4e0f-af89-17884656059d',
      },
      {
        text: `Cartagena del Chairá`,
        metadataId: '0c5d4895-e1fa-446a-ad46-47c93d3d6c6e',
      },
      { text: `Curillo`, metadataId: '9d49b286-8664-48ce-a1a5-cfa5cc6e9446' },
      {
        text: `El Doncello`,
        metadataId: 'bb75f61e-5440-4c3f-b4f0-9b7f3765da3c',
      },
      ...
      {
        text: `Medio Atrato`,
        metadataId: '96c46200-5f97-4f0d-9d8a-b01f56ab3617',
      },
      {
        text: `Medio Baudó`,
        metadataId: 'd9ceb535-ff0e-4c20-873f-50fe581e443c',
      },
      {
        text: `Medio San Juan`,
        metadataId: 'e6cc6c97-7e0a-4dd2-9147-773bc4d29c92',
      },
      ...
      { text: `Riosucio`, metadataId: 'cbbe0e58-46cb-445e-98a0-a02795b33e57' },
      {
        ...
        metadataId: '8785236a-fe36-4821-9ee1-906129f523fb',
      },
      ...
      { text: `Unguía`, metadataId: '8cd3367d-319f-4cbc-ae8c-0d6111f9cdfa' },
      {
        ...
        metadataId: '4424edf9-4e1d-4605-91ff-ee1e820e20a3',
      },
      ...
      {
        text: `Cantón de San Pablo`,
        metadataId: '00fc39b7-e8a4-4730-93cc-8813ba06cae5',
      },
      {
        text: `El Carmen del Darién`,
        metadataId: '7294c0c2-60aa-48b3-a121-88550760f533',
      },
      ...
      {
        text: `Distracción`,
        metadataId: 'ed629d06-c13f-44db-ac44-7b309d07dbb1',
      },
      ...
      { text: `Hatonuevo`, metadataId: 'f579acca-5058-463c-a346-cd6766ae1bef' },
      {
        ...
        metadataId: 'e7d60f0a-e5c6-4c2b-bf2a-0331e79857f3',
      },
      ...
      { text: `Mesetas`, metadataId: 'e815eb0c-dd88-4140-a8c2-f613187f5c01' },
      {
        ...
        metadataId: 'ba108077-ad58-4073-91cf-cfc4528c9141',
      },
      {
        text: `Puerto Gaitán`,
        metadataId: 'ffc66c6d-fa2e-48b4-8e66-232fa5f9b580',
      },
      {
        text: `Puerto Lleras`,
        metadataId: '11e85632-fc04-499d-a285-fb17dde84f56',
      },
      {
        text: `Puerto López`,
        metadataId: '18c774df-8570-4f2c-8fbc-82cae5ec6d9e',
      },
      {
        text: `Puerto Rico`,
        metadataId: '070fb07b-eb28-41a3-a2e1-6aa11e2257e6',
      },
      { text: `Restrepo`, metadataId: '76ecfaa2-0d7a-4d98-8473-9ca694048d38' },
      {
        text: `San Carlos de Guaroa`,
        metadataId: 'cc47884d-1d36-414d-bb15-00d76abcdd2c',
      },
      {
        text: `San Juan de Arama`,
        metadataId: '93ec6cc1-f955-4ace-b0f7-e67d392cd713',
      },
      {
        text: `San Juanito`,
        metadataId: 'f8a19f00-f16e-47e0-b756-481c612ff829',
      },
      {
        text: `San Martín`,
        metadataId: '9ed72c85-6575-481a-a2db-b3957769bb52',
      },
      {
        text: `Vistahermosa`,
        metadataId: 'cf1138bd-0e3f-4f19-b0c3-406938a429eb',
      },
      ...
      {
        text: `Bucarasica`,
        metadataId: '10e1f06f-80f9-4582-bb59-c5f194345dc2',
      },
      ...
      {
        text: `Convención`,
        metadataId: '34541c44-d558-4f10-90c5-5de26216d7d3',
      },
      ...
      {
        text: `La Esperanza`,
        metadataId: '2c9d4bef-8baa-400e-a492-617ae7c9b3db',
      },
      {
        text: `La Playa de Belén`,
        metadataId: '6484c9a2-c383-4836-9404-d743e46e61b5',
      },
      {
        text: `Los Patios`,
        metadataId: '4b4b930f-2065-475d-b1f3-ffe2db93f38e',
      },
      ...
      {
        text: `Pamplonita`,
        metadataId: '9da464f9-67a6-4d85-bca4-c396dcf47e49',
      },
      {
        text: `Puerto Santander`,
        metadataId: 'd4badc56-bbe8-4eb8-8041-1f7fa721f002',
      },
      {
        text: `Ragonvalia`,
        metadataId: '9eef6401-3dd5-41b8-9eb6-01509c9b0679',
      },
      { text: `Salazar`, metadataId: '834e0af8-8f03-44a6-bf15-c3f15070d39d' },
      {
        text: `San Calixto`,
        metadataId: '018b9fea-3a7b-4103-909f-7bfd3dad00b1',
      },
      {
        text: `San Cayetano`,
        metadataId: '8f5d1e10-4fb6-4ac5-84a4-4591bf4b54dd',
      },
      ...
      {
        text: `Villa Caro`,
        metadataId: 'a20d0041-1ca0-4b2c-b231-298f28fe1452',
      },
      {
        text: `Villa del Rosario`,
        metadataId: '9efaa20b-05dd-4923-a788-99f112ada15b',
      },
      { text: `Abriaquí`, metadataId: '14eb3ac6-a330-4032-a245-bc14b04a2fe5' },
      {
        text: `Alejandría`,
        metadataId: 'fb681017-c647-453a-9567-19dc86ea3718',
      },
